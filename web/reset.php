...
<body>
              ...
              <div class="row">
                  <div class="col-lg-12 text-center">
                            <div class="alert alert-danger">
                                <strong>Sukces!</strong> RESET zdalnego URZĄDZENIA potrwa około 75 sekund...
                            </div>
                  </div>
              </div>
              <!-- /.row -->
  ...
  // $lz->refresh();
  if (!empty($_GET['action'])) { $a = ($_GET['action']); echo($lz->comm($a)); header("Refresh:70; url=index.php"); }
  ?>
